        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-300 text-xl">
              Advanced AI-powered computer vision platform combining multispectral fusion, 
              defect detection, predictive maintenance, and edge deployment for mission-critical applications.
            </p>
          </div>
        </div>
      </section>
