        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-48">
          <div className="max-w-3xl">
            ...
            <h1 className="text-white mb-6">
              Advanced AI Vision for Defense & Commercial Applications
            </h1>
            <p className="text-slate-300 text-xl mb-8">
              GEM delivers cutting-edge artificial intelligence solutions powered by multispectral fusion 
              and edge-deployed computer vision. Serving U.S. federal agencies and commercial clients 
              with mission-critical AI technology.
            </p>
